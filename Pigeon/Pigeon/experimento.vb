Public Class formExperimento
    ...
    Private Sub formExperimento_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Box.interfaceIOPresent Then
            Terminal("KDigitalIo não está presente! Por isso não será utilizada.")
        End If
        ...
        If intPosicaoAtual <= ListBoxExperimento.Items.Count - 1 Then
            ...
            If formConfig.RadioButtonMTS.Checked Then
                ...
                If arrayOpcoes.Length <> 5 Then
                    MsgBox("Arquivo Incorreto para MTS!", MsgBoxStyle.Information)
                    Box.Close()
                    ShowHideCursor(1)
                    Me.Dispose()
                    Exit Sub
            ...
            ElseIf formConfig.RadioButtonMTSTime.Checked Then
                ...
                If arrayOpcoes.Length <> 6 Then
                    MsgBox("Arquivo Incorreto para MTS Time!", MsgBoxStyle.Information)
                    Box.Close()
                    ShowHideCursor(1)
                    Me.Dispose()
                    Exit Sub
    ...
    'Private Sub pictureC_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pictureC.Click
    ...
    Private Sub writeParameters()
        ...
        strRelatorio = strRelatorio & vbCrLf & "Chk Beep:" & vbTab & formConfig.CheckBoxBeepResposta.Checked.ToString()
